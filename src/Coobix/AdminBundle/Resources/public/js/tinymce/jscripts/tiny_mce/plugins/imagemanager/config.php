<?php
	...
	include("symfony_bootstrap.php");
	//$mcImageManagerConfig['filesystem.path'] = '../../../../../../../../../../../web/uploads/users/otro/'; // absolute or relative from this script path, optional.
	//$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../../../../../../web/uploads/users/otro/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['thumbnail.folder'] = "uploads"; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
